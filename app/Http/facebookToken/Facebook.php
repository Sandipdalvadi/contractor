...
use App\Http\facebookToken\FileUpload\ResumableUploader;
use App\Http\facebookToken\FileUpload\TransferChunk;
use App\Http\facebookToken\FileUpload\Video;
use App\Http\facebookToken\GraphNode\GraphEdge;
use App\Http\facebookToken\Url\UrlDetectionInterface;
use App\Http\facebookToken\Url\UrlDetectionHandler;
use App\Http\facebookToken\PersistentData\PersistentDataFactory;
use App\Http\facebookToken\PersistentData\PersistentDataInterface;
use App\Http\facebookToken\Helper\CanvasHelper;
use App\Http\facebookToken\Helper\JavaScriptHelper;
use App\Http\facebookToken\Helper\PageTabHelper;
use App\Http\facebookToken\Helper\RedirectLoginHelper;
...
class Facebook
{
     ...
     */
    const APP_ID_ENV_NAME = '2628932507423359';

    /**
     * @const string The name of the environment variable that contains the app secret.
     */
    const APP_SECRET_ENV_NAME = 'a48b4b47c0837808e616d777df3be472';
    ...
    {
        $config = array_merge([
            'app_id' => '2628932507423359',
            'app_secret' => 'a48b4b47c0837808e616d777df3be472',
