            ...
            <div class="navbar-wrapper">
                ...
                <div class="navbar-logo">
                    ...
                    <a href="#" style="display: flex; align-items: center; font-size: 15px; font-weight: 600;">
                        <img class="img-fluid" src="{{ public_url('/default_images/logo.png') }}"
                            style="height:40px; margin-right: 10px;" alt="Theme-Logo">
                    </a>
                    ...
                    <ul class="nav-right">
                        <li class="header-notification">
                            <div class="dropdown-primary dropdown">
                                ...
                                <div class="show-notification notification-view dropdown-menu noti-ul"
