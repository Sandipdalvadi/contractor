                    ...
                    <div id="login" class="tab-pane fade in active white-text">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 zero-padding-left">
                            <ul class="nav nav-pills ">
                                <li class="active"><a
                                        href="javascript:void(0)">{{ __('Please confirm your password before continuing.') }}</a>
                                </li>
                            </ul>
                            <form name="contact_us" class="contact_us" action="{{ route('password.confirm') }}"
                                method="POST">
                                @csrf
                                ...
                                <div class="form-group submit">
                                    ...
                                    <input type="submit" name="submit" value="{{ __('Confirm Password') }}" class="signin"
                                        id="signin">
                                </div>
