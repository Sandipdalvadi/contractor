    ...
    <div class="row">
        <div class="container main-container-home">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                ...
                <p>An employment website is a web site that deals specifically with employment or careers. Many
                    employment websites are designed to allow employers to post job requirements for a position to be
                    filled and are commonly known as job boards</p>
            </div>
