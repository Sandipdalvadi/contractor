...
<div class="container-fluid white-bg contact_us">
    <form action="" name="contact_us" id="form-style-2">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                           <input type="text" name="you-name" placeholder="Martin Trojanowski"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group file-type ">
                        ...
                        <div class="col-lg-8 col-md-8  col-sm-8 col-xs-12">
                           <input type="file" name="post-image" class="inputfile" id="select_file" placeholder="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-3  col-md-3  col-sm-6  col-xs-12"> 
                           <input type="text" name="your-rate" placeholder=""/>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                           <select class="form-control item-list" id="skills" multiple="multiple">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-3  col-md-3  col-sm-6  col-xs-12"> 
                           <input type="text" name="name-url" placeholder=""/>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    <div class="form-group">
